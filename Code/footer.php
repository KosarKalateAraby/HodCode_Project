        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
                <div class="d-flex flex-column align-items-center align-items-md-start mt-5">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/image/enamad.jpg" alt="eNAMAD Logo" class="img-fluid mb-3 mt-5" style="width: 100px; height: 100px;">
                    <!-- <p>www.eNAMAD.ir</p> -->
                </div>
            </div>
            <!-- ستون دوم برای نمایش اطلاعات تماس -->
            <div class="col-md-4 mb-4 mb-md-0">
                <h3 class="font-weight mb-1 text-right">اطلاعات تماس</h3>
            ...
            <div class="col-md-4">
                <h3 class="font-weight mb-1 text-right">لینک‌های مفید</h3>
...
<!-- افزودن رنگ سفارشی به فایل -->
<style>
    .bg-custom-dark {
        background-color: #00264D;
        /* رنگ آبی تیره مشابه تصویر */
    }
</style>
